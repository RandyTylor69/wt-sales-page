...
export default function Services() {
  return (
    <div className="h-auto w-auto">
      <section className="flex flex-col items-center justify-center px-10 py-30 md:px-20 xl:px-80">
        ...
        <article className="flex flex-col md:flex-row w-full justify-between border-t-6 mb-12">
          <a
            target="_blank"
            className="mt-4 hover:decoration max-w-90 text-4xl md:text-5xl lg:text-6xl tracking-tightest uppercase hover:underline hover:underline-offset-2"
          ...
          <div className="flex p-4 justify-center gap-4 mx-8 md:mx-12">
            <Image
